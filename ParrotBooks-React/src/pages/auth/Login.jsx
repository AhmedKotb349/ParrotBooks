...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-brand-700 px-4">
      <div className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-2xl shadow-xl p-6 sm:p-8">
        <div className="text-center mb-6">
          <img src={logo} alt="Parrot Books" className="w-16 h-16 rounded-full mx-auto mb-1 shadow-md" />
