...
export default function Invoices() {
  ...
  return (
    <div>
      ...
      {uninvoiced.length > 0 && (
        <>
          ...
          <div className="space-y-2 mb-6">
            {uninvoiced.map((d) => (
              <div key={d._id} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 flex flex-col sm:flex-row sm:items-center gap-3 sm:justify-between">
      ...
      <div className="table-scroll rounded-xl border border-slate-200 dark:border-slate-800">
      <table className="w-full text-sm bg-white dark:bg-slate-900 min-w-[420px]">
